...
public class YamlDataSerializerTests
{
    ...
    [Fact]
    public void Format_Returns_Yaml()
    {
        // Arrange
        var sut = new YamlDataSerializer();

        // Act
        var format = sut.Format;

        // Assert
        format.Should().Be(DataOutputFormat.Yaml);
    }

    [Fact]
    public void Serialize_WithObject_ProducesCamelCaseYaml()
    {
        // Arrange
        var sut = new YamlDataSerializer();
